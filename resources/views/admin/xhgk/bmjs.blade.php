        ...
        <table class="table">
            ...
            @if(count($results) != 0)
                @foreach($results as $result)
                    <tr>
                        <th><input type="text" name="dpt[]" class="input-sm" value="{{$result->dpt}}"/></th>
            ...
            @else
                <tr>
                    <th><input type="text" name="dpt[]" class="input-sm" value=""/></th>
